defmodule BotArmyOutreach.Skills.Example do
  @moduledoc """
  Example skill for Outreach Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_outreach.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_outreach.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_outreach/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_outreach.command.example"
    ]
  end
