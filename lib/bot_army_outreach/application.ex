defmodule BotArmyOutreach.Application do
  @moduledoc """
  Outreach Bot application supervisor.
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: BotArmyOutreach.Supervisor]
  ...
  defp maybe_add_pulse_publisher(children) do
    if @env == :test do
      ...
      [{BotArmyOutreach.PulsePublisher, []} | children]
    end
  end
