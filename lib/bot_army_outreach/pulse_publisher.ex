defmodule BotArmyOutreach.PulsePublisher do
  @moduledoc """
  Periodic health publisher for Outreach Bot.
  ...
  2. **`bot.outreach.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @envelope_source "bot_army_outreach"
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting Outreach Bot pulse publisher")
