defmodule BotArmyOutreach.ExampleTest do
  @moduledoc """
  ...
  describe "module initialization" do
    test "application starts without errors" do
      assert BotArmyOutreach.Application != nil
    end
  end
  ...
  describe "pulse publisher" do
    test "pulse publisher module exists" do
      ...
      assert module_exists?(BotArmyOutreach.PulsePublisher)
    end
  end
  ...
  describe "http client behavior" do
    test "http client behavior is defined" do
      ...
      assert module_exists?(BotArmyOutreach.HTTPClient)
      assert module_exists?(BotArmyOutreach.HTTPClient.Req)
    end
  end
