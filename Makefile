...
compile:
	@LOG_FILE="/tmp/compile-outreach-$$(date +%s).log"; \
	echo "Compiling outreach and logging to $$LOG_FILE..."; \
...
release: check
	...
	@echo "==============================================="
	rm -rf _build/prod/rel/outreach_bot
	MIX_ENV=prod $(MIX) release
	@echo ""
	@echo "✓ Release built successfully"
	@echo "Location: _build/prod/rel/outreach_bot/"
	@echo ""
...
publish-release: release
	...
	TARBALL="outreach_bot-$$VERSION.tar.gz"; \
	echo "Version: $$VERSION"; \
	echo "Creating release tarball..."; \
	tar -czf "$$TARBALL" -C _build/prod/rel outreach_bot/; \
	...
	if gh release view "v$$VERSION" >/dev/null 2>&1; then \
		...
		gh release create "v$$VERSION" "$$TARBALL" \
			...
			--notes "Outreach Bot Elixir release v$$VERSION. Download and deploy with Jenkins." \
			--draft=false; \
	fi; \
