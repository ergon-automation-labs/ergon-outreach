defmodule BotArmyOutreach.HTTPClient do
  @moduledoc """
  ...
  Pass http_client as an option in init:
      def init(opts) do
        http_client = Keyword.get(opts, :http_client, BotArmyOutreach.HTTPClient.Req)
...
defmodule BotArmyOutreach.HTTPClient.Req do
  @moduledoc """
  Real HTTP client implementation using the Req library.
  """

  @behaviour BotArmyOutreach.HTTPClient
